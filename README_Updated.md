...
A fully serverless customer feedback platform built on AWS that collects
customer feedback through a web application, performs sentiment analysis
using Amazon Comprehend, stores the results in DynamoDB, sends real-time
email alerts for negative feedback using Amazon SNS, and presents
analytics through an interactive dashboard.

This project demonstrates the design and implementation of a modern
serverless application using AWS managed services with a focus on
scalability, automation, and cost efficiency.
...
8.  The analytics dashboard retrieves aggregated statistics through the
    `/stats` API.
...
-   Migrate to private S3 bucket using Origin Access Control (OAC)
-   Route 53 custom domain
-   AWS Certificate Manager (HTTPS)
-   Custom domain with Route 53
-   GitHub
-   GitHub Actions
-   Amazon CloudFront Actions CI/CD (implemented)
...
GitHub: https://github.com/Francis-Ocran-git
